...
public:
    ...
    void seed(InputIter begin, InputIter end) {
        ...
        // For very small sizes, we do some additional mixing.  For
        // normal
...
public:
    ...
    const base_seed_seq &base() const { return *this; }
